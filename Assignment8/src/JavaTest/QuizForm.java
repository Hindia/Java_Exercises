...
public class QuizForm extends javax.swing.JFrame {
    ...
    public QuizForm() {
        ...
        collection.readQuestions();
        jTextArea1.append("You will be given five questions."
                + "\nProgram will close after the fifth question."
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        collection.setMax(4-i);
        i = i + 1;
        if (i == 6) {
            jTextArea1.setText(null);
            jTextArea1.append("End of Questions. Thank You!");
            this.dispose();
        } else {
            jTextArea1.setText(null);
            jTextArea1.append(collection.RandQuestion());
